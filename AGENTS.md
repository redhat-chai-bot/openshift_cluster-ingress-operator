...
5. **GNU changelog-style file summary** — list each changed file with a
   parenthesized function or method name where applicable.  Do not repeat text
   that is identical across successive changelog entries; use "Likewise." or
   describe only what differs.
